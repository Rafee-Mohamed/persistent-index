...
class PersistentBPlusTreeOracleTest {
    ...
    /** {@link io.dsal.persistent.index.layout.PackedByteKeyStorage} + lexicographic order (same as {@link TreeMapOracle}). */
     ...
     * {@link io.dsal.persistent.index.layout.PackedByteKeyStorage}: variable-length non-empty

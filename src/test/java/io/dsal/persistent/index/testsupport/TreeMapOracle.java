...
/**
 * Reference model for {@link io.dsal.persistent.index.core.PersistentBPlusTree} tests:
 ...
 * {@link io.dsal.persistent.index.core.PersistentBPlusTree#range(Object, Object)}).
 *
 * @param <K> key type
 * @param <V> value type
 */

...
public final class KeyStorageTestSupport {
    ...
    /**
     * Sorted {@link PackedByteKeyStorage} from distinct key slices (lexicographic order must match
     * slice order).
     */
    ...
    /** Single-byte keys {@code fromInclusive..toInclusive} in order. */
    ...
    /**
     * Sorted {@link PackedByteKeyStorage} from UTF-8 string keys. Callers must supply strings in
     * strict lexicographic (byte) order.
     */

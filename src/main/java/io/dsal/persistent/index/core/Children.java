 ...
 * {@link io.dsal.persistent.index.layout.KeyStorage} in {@link PersistentBPlusTree};
 ...
 * unlike {@link io.dsal.persistent.index.layout.KeyStorage#insert(int, Object)}.
 * Leaves use {@link io.dsal.persistent.index.layout.ValueStorage}.</p>
 *
 * @param <K> key type
 * @param <V> value type
 * @see Node.Internal
...
public class Children<K, V> {
     ...
     * (no append at {@code size}; unlike {@link io.dsal.persistent.index.layout.KeyStorage#insert(int, Object)}).
     *
     * <pre>
     ...
     * {@link io.dsal.persistent.index.layout.KeyStorage#removeAndInsert(int, int, Object)}.
     * Length unchanged.
     *
     * <pre>
     ...
     * {@link io.dsal.persistent.index.layout.KeyStorage#insertAndSplit(int, int, Object)}:
